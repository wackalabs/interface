...
/**
 * Returns the best v2 trade for a desired discover
 * @param tradeType whether the discover is an exact in/out
 * @param amountSpecified the exact amount to discover in/out
