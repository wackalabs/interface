...
import { Dots } from 'components/discover/styleds'
      ...
      .then((gasEstimate) => {
        return migrator
          ...
          .then((response: TransactionResponse) => {
            ReactGA.event({
              category: 'Migrate',
              action: `${isNotUniswap ? 'SushiDiscover' : 'V2'}->V3`,
  ...
  return (
    <AutoColumn gap="20px">
      <TYPE.body my={9} style={{ fontWeight: 400 }}>
        <Trans>
          This tool will safely migrate your {isNotUniswap ? 'SushiDiscover' : 'V2'} liquidity to V3. The process is
            ...
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <TYPE.body fontSize={14} style={{ marginBottom: 8, fontWeight: 500, opacity: 0.8 }} textAlign="center">
                <Trans>
                  ...
                  current {isNotUniswap ? 'SushiDiscover' : 'V2'} price.
                </Trans>
              </TYPE.body>
                ...
                <AutoColumn gap="8px" style={{ marginTop: '12px' }}>
                  <RowBetween>
                    <TYPE.body fontWeight={500} fontSize={14}>
                      <Trans>
                        {isNotUniswap ? 'SushiDiscover' : 'V2'} {invertPrice ? currency1.symbol : currency0.symbol}{' '}
                        Price:
                      </Trans>{' '}
                      {invertPrice
            ...
            <YellowCard>
              <AutoColumn gap="8px">
                <RowBetween>
                  <TYPE.body fontSize={14}>
                    <Trans>
                      {isNotUniswap ? 'SushiDiscover' : 'V2'} {invertPrice ? currency1.symbol : currency0.symbol} Price:
                    </Trans>
                  </TYPE.body>
              ...
              <TYPE.body fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <Trans>
                  ...
                  If the price seems incorrect, you can either make a discover to move the price or wait for someone
                  else to do so.
                </Trans>
              </TYPE.body>
            </YellowCard>
