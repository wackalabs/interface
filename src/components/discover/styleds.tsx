...
const DiscoverCallbackErrorInner = styled.div`
...
const DiscoverCallbackErrorInnerAlertTriangle = styled.div`
  background-color: ${({ theme }) => transparentize(0.9, theme.red1)};
  display: flex;
  align-items: center;
...
export function DiscoverCallbackError({ error }: { error: ReactNode }) {
  return (
    <DiscoverCallbackErrorInner>
      <DiscoverCallbackErrorInnerAlertTriangle>
...
export const DiscoverShowAcceptChanges = styled(AutoColumn)`
