...
import { AdvancedDiscoverDetails } from './AdvancedDiscoverDetails'
import { DiscoverShowAcceptChanges, TruncatedText } from './styleds'
...
export default function DiscoverModalHeader({
  trade,
  allowedSlippage,
  recipient,
  showAcceptChanges,
  ...
  return (
    <AutoColumn gap={'4px'} style={{ marginTop: '1rem' }}>
      ...
      <LightCard style={{ padding: '.75rem', marginTop: '0.5rem' }}>
        <AdvancedDiscoverDetails trade={trade} allowedSlippage={allowedSlippage} />
      </LightCard>

      {showAcceptChanges ? (
        <DiscoverShowAcceptChanges justify="flex-start" gap={'0px'}>
          <RowBetween>
            <RowFixed>
