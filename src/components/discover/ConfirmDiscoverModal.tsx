...
export default function ConfirmDiscoverModal({
  trade,
  originalTrade,
  onAcceptChanges,
  allowedSlippage,
  ...
  const pendingText = (
    <Trans>
      Discoverping {trade?.inputAmount?.toSignificant(6)} {trade?.inputAmount?.currency?.symbol} for{' '}
  ...
  const confirmationContent = useCallback(
    () =>
      swapErrorMessage ? (
        ...
        <ConfirmationModalContent
          title={<Trans>Confirm Discover</Trans>}
          onDismiss={onDismiss}
