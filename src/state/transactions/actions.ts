...
interface BaseDiscoverTransactionInfo extends BaseTransactionInfo {
...
export interface ExactInputDiscoverTransactionInfo extends BaseDiscoverTransactionInfo {
  tradeType: TradeType.EXACT_INPUT
  inputCurrencyAmountRaw: string
  expectedOutputCurrencyAmountRaw: string
  minimumOutputCurrencyAmountRaw: string
}
export interface ExactOutputDiscoverTransactionInfo extends BaseDiscoverTransactionInfo {
...
export type TransactionInfo =
  ...
  | ExactOutputDiscoverTransactionInfo
  | ExactInputDiscoverTransactionInfo
